              ...
              <p style={{display:"none"}}>
                ...
                <p className="card-text text-center">
                  {q.weather[0].description === "parçalı bulutlu"
                    ? <img src={iconset["parçalı bulutlu"]} width="50" height="50" alt=""/>
                    : null}
                  {q.weather[0].description === "kapalı"
                    ? <img src={iconset["kapalı"]} width="50" height="50" alt=""/>
                    : null}
                  {q.weather[0].description === "hafif yağmur"
                    ? <img src={iconset["hafif yağmur"]} width="50" height="50" alt=""/>
                    : null}
                  {q.weather[0].description === "açık"
                    ? <img src={iconset["açık"]} width="50" height="50" alt=""/>
                    : null}
                  {q.weather[0].description === "parçalı az bulutlu"
                    ? <img src={iconset["parçalı az bulutlu"]} width="50" height="50" alt=""/>
                    : null}  
                  {q.weather[0].description === "orta şiddetli yağmur"
                    ? <img src={iconset["orta şiddetli yağmur"]} width="50" height="50" alt=""/>
                    : null} 
                  {q.weather[0].description === "az bulutlu"
                    ? <img src={iconset["az bulutlu"]} width="50" height="50" alt=""/>
                    : null} 
                  {q.weather[0].description === "şiddetli yağmur"
                    ? <img src={iconset["şiddetli yağmur"]} width="50" height="50" alt="" />
                    : null} 
                </p>
                <p className="card-text text-center">
